...
## Design of modified 3'UTRs for testing the effects of inserted motifs

A pair of suitable 3'UTR's from the Pelechano et al (2013) median length 3'UTR dataset were chosen for testing the effect of  introducing the selected motifs of interest on gene expression.
The primary selection criteria for these 3'UTRs were; 1) that they do not contain any motif of interest, 2) possess a length of less than 300 nt (including terminator sequence), 3) are from the top 5% most abundant mRNAs in the Nadal-Ribelles et al (2019) scRNA-seq dataset.
...
The positions for inserting the motifs of interest were selected by first avoiding any efficiency elements or polyadenylaton sites in the chosen 3'UTRs.
Then, the position was matched to the average position of the motifs in the 3'UTR's in which they appear natively.
The final position selection also considered regions that minimally disrupt the 3'UTR secondary structure compared to wild type 3'UTR.
