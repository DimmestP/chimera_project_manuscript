...
We also confirmed that most differences in protein outputs are accounted for by mRNA abundance by checking a subset of mCherry constructs using RT-qPCR ($R = 0.888$, Figure \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)D).
...
To quantify the effects and composability of selected short CREs in different contexts, we designed a further set of reporter constructs (Figure \@ref(fig:tRPS3-tTSA1-design-and-qpcr)A).
...
Insertion of either TGTAHMNTA, or 2 copies of HWNCATTWY, tends to decrease mRNA abundance, and their combined insertion tends to decrease mRNA abundance even further.
The putative stability motif GTATACCTA does not consistently or strongly affect mRNA abundance.
...
Interestingly, motif effects on mRNA abundance appear to have consistently greater correlation with predicted effects when their host terminator is paired with its native promoter. 
