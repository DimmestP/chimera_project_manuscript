...
Surprisingly, tRPS3 mod_NNN constructs appear to be using a novel upstream poly(A) site, that appears in about $50%$ percent of reads and does not include the 3rd motif insertion site (Figure \@ref(fig:quantseq-polyA-site-usage)B).
