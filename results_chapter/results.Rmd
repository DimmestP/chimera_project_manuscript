...
We selected a subset of constructs to determine if motifs insertion causes alternative transcript polyA site usage using polyA anchored RNA-Seq.
...
Focusing on reads mapped downstream of contruct stop codons we can see a shift in polyA site in response to motif insertion compared to WT (Figure \@ref(fig:quantseq_polyA_aite_usage)B).

```{r quantseq_polyA_aite_usage, fig.cap="", fig.align='center',out.width="85%"}
