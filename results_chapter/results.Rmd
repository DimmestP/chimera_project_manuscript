...
69 suspected post-transcriptional, cis-regulatory elements were collated from three separate studies; @Hogan2008, @Shalgi2005 and @Cheng2017.
All collated cis-regulatory elements were sequence motifs found in transcript 3' untranslated regions (3'UTR) as confirmed either in vivo, with RNA-protein binding assays [@Hogan2008], or in silico, by comparing the sequences of transcripts with similar half lives [@Shalgi2005] [@Cheng2017].
...
A transcript's median length 3'UTR was determined either as reported by @Pelechano2013 or, for genes missing in the TIF-seq dataset, inferred by taking the first 200 nucleotides downstream of the gene's stop codon.
...
The linear model was trained separately on two independent, genome-wide studies of yeast mRNA decay rates, [@Sun2013] and [@Chan2018].
...
The predictive power of the models with the maximum AIC can be seen in Figure \@ref(fig:hlife-decay-model)A; ??% and 51% of the variability in half lives was explained for the [@Sun2013] and [@Chan2018] data sets respectively.
