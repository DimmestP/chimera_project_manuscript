...
We checked if differences in RNA abundance were reflected in protein expression, by comparing the RT-qPCR with fluorescence plate reader measurements for a a subset of constructs with native promoter-terminator pairings (Fig \@ref(fig:protein-vs-RNA-plot-motifs)). 
The high correlation ($R = 0.96, 0.68, 0.96$ for tRPS3, tTSA1, tPIR1 constructs respectively) argues that these combinations of decay motifs that change RNA abundance also change the protein output, as predicted.
