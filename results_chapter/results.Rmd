...
We added t and p prefixes to native gene names to denote references to terminator/promoter regions.
...
Promoter choice dominated overall gene expression with over 100 fold changes in fluorescence between the four highest expressing promoters, Fig \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)A, and the two lowest expressing promoters, Fig \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)B.
...
We also measured the mRNA levels of a subset of mCherry constructs and confirmed the effects seen on protein expression correlate with transcript levels, Fig \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)C.

We normalised the fluorescence of each construct to the PGK1 terminator its promoter-ORF set in order to explore the context dependence of each terminator, Fig \@ref(fig:pro-ter-platereader-mCherry-mTurq-norm)A.
