...
We also confirmed that most differences in protein outputs are already present in mRNA abundance by checking a subset of mCherry constructs using RT-qPCR (Figure \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)D).
...
Note that we used the longer 543bp SRO9 terminator, and a similarly extended 421bp tPMA1, for the main set of constructs (Figure \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)).
