...
To investigate the context dependence of cis-regulatory regions, we created a library of 120 constructs containing all combinations of 6 promoters (including 5'UTR), 2 coding sequences, and 10 terminators (including 3'UTR).
...
We observed 100-fold changes in fluorescence between the 4 highest expressing promoters (Figure \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)A) and the 2 lowest expressing promoters (Figure \@ref(fig:pro-ter-platereader-mCherry-mTurq-raw)B) across both coding sequences.
...
We focus on constructs with high-expression promoters due to the poor signal to noise ratio at low fluorescence levels.
...
Insertion reporter constructs contain combinations of inserted motifs in each of 2 host terminators, expressing mCherry from each of 3 different promoters.
...
We chose TGTACAATA and TTTCATTTC sequences as explicit versions of the TGTAHMNTA and HWNCATTWY consensus motifs respectively, and checked that these explicit versions have similar predicted effect on half-life transcriptome-wide (Supplementary Tables \@ref(tab:TGTACAATA-motif-coef), \@ref(tab:TTTCATTTC-motif-coef)).
...
Insertion of 2 copies of ATATTC into generally lowers the mRNA abundance, as much as 4-fold when paired with the pRPS3 promoter.
...
This is true for all 3 decay motifs across all 3 host terminators, except for TTTCATTTC in pRPS3-tRPS3 constructs.

Regulatory interactions between different motifs inserted into a terminator also change depending on both host terminator and promoter context.
