...
We checked that in other genes the poly(A) site locations were highly reproducible across samples, giving us confidence that changes in construct poly(A) sites are meaningful (Figures \@ref(fig:rnaseq-QC-QuantSeq-genomic-polyA) and \@ref(fig:rnaseq-QC-5PSeq-genomic-polyA)).
