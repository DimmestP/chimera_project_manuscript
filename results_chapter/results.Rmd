...
Terminators that have consistently low expression include tSUN4 and tTOS6, taken from cell wall proteins whose transcripts are bound and regulated by overlapping RNA-binding proteins [@Hogan2008].
...
Overall, our results show that the contributions of terminators (including 3'UTRs) to gene expression depend on the sequences in other parts of the gene, and are consistent between co-regulated genes.
