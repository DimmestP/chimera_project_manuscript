...
To quantify the effect of selected short CREs in different contexts, we designed a further set of reporter constructs  (Figure \@ref(fig:tRPS3-tTSA1-design-and-qpcr)A).
...
Inserting the same motifs into our second host terminator gives qualitatively similar results (Supplementary Figure \@ref(fig:tRPS3-tTSA1-design-and-qpcr)A).
...
We confirmed that motif-dependent changes in mRNA abundance are reflected in protein abundance by measuring the fluorescence from a subset of reporter constructs with native promoter-terminator pairings (Figure \@ref(fig:protein-vs-RNA-plot-motifs)). 
...
We compared our predictive model of the effects of cis-regulatory motifs -- inferred from transcriptome-wide measurements of half-life -- and their effects when inserted or removed from reporter constructs.
