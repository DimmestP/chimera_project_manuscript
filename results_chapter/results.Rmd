...
We next asked if the alternate poly(A) sites might have different decay rates, using 5Pseq to measure decapped transcripts, which are decay intermediates.
This largely confirms the QuantSeq results and provides no evidence for differential decay (Sup Fig \@ref(fig:polyA-site-usage-5Pseq)).
MORE HERE.
