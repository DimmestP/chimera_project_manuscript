...
5PSeq library was prepared as described in **Zhang & Pelechano 2021** with following modifications: anchored-oligodT was used instead of oligo-dT to allow for sequencing of 3'-ends; random primers were not used.
...
5'P ends were analysed using fivepseq pipeline **(Nersisyan 2020)**.
...
Coefficients were reported for the significant motif versions (Supplementary Table
\ref{tab:HWNCAUUWY-motif-coef}, \ref{tab:TGTAHMNTA-motif-coef}). 
