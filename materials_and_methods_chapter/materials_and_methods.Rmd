...
These positions were selected based on key design criteria including minimal perturbations of RNA secondary structure as predicted by RNAfold [@Lorenz2011], see **(Supplementary Figure X)**.
...
Again, median 3'UTRs were extracted from the Pelechano et al. (2013) dataset filtered for the following criteria; 1) contains at least 3 shortlisted motifs of interest, 2) a highly expressed gene, 3) synthesisable.
...
3) Mutations that resulted in a limited change in the predicted secondary structure and minimum free energy (MFE) according to RNAfold [@Lorenz2011], see Supplementary Figure \@ref(fig:secondary-structure-PIR1). 
