...
Using these parts libraries, the promoter, ORF and terminators were assembled together by into the transcription unit acceptor plasmids (POT1-ccdB) by Golden Gate assembly using Esp31 (NEB); these are low-copy centromeric plasmids with URA3 selection, as described in @Garcia2018.
...
Yeast with plasmids were grown were grown in a 96 deepwell plate (VWR) containing 100$\mu$l  of SC -URA medium with 2% glucose and grown for ~12 hours at 30&deg;C in a shaking incbator set at 250 rpm. 
