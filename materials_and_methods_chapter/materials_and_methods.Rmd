...
DNA sequences used in this study are summarised in Supplementary Tables 1 and 2. 
...
All primer sets were thoroughly validated by serial dilution and by confirming amplicon size, sequences are available in Supplementary Table 3.
...
These positions were selected based on key design criteria, including; minimal perturbations of RNA secondary structure as predicted by RNAfold [@Lorenz2011], position of motifs in native 3'UTRs and position of other CREs important for transcriptional control (Supplementary Table 6, Supplementary Figure 1).
...
3) Mutations that resulted in a limited change in the predicted secondary structure and minimum free energy (MFE) according to RNAfold [@Lorenz2011], see Supplementary Table 6).
