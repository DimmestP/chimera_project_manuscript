...
Further detail on the Golden Gate assembly is described in https://www.protocols.io/view/golden-gate-assembly-esp31-or-bsa1-v2-hf-bkqrkvv6.
...
Yeast with plasmids were grown in a 96-well deep well plate (VWR) containing 100μl of SC-Ura medium with 2% glucose and grown for ~12 hours at 30°C in a shaking incubator set at 250 rpm. 
...
Further details regarding the growth and preparation of the plate reader assay is outlined in the following protocol - https://www.protocols.io/view/96-well-plate-reader-experiment-set-up-from-a-96-d-bbicikaw.
...
The pelleted cells were thawed and individually resuspended in 400 μl of RNA binding buffer (Zymo), then transferred to 2 ml screw cap tubes containing zirconia beads, lysed using the Precellys Evolution homogeniser then pelleted by centrifugation for 1.5 minutes. 
...
The column was washed with 700 μl of Zymo DNA/RNA Wash buffer (Zymo) then centrifuged. 
The column was washed a second time, but with 400 μl of Zymo DNA/RNA Wash buffer (Zymo). 
The column was centrifuged once more to remove residual wash buffer in the column. Lastly, 30 μl of nuclease free water was added to the column then eluted. 
All centrifugation steps in the RNA extraction protocol were carried out at 12,000g for 1 minute unless otherwise stated. 
Further details on the growth of yeast and extraction of the RNA are outlined in the following protocol - https://www.protocols.io/view/column-based-rna-extraction-from-yeast-s-cerevisia-beetjben.
