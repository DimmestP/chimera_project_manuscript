...
This created three parts libraries; promoter-HcKan_P, ORF-HcKan_O and terminator-HcKan_T. 
Using these parts libraries, the promoters, coding sequences and terminators were assembled together into the transcription unit acceptor plasmids (POT1-ccdB) by Golden Gate assembly using Esp3I (NEB); these are low-copy centromeric plasmids with URA3 selection marker, as described in @Garcia2018.
...
Yeast with plasmids were grown in a 24-well deep well plate plate (4titude) containing 1.5 ml of SC-Ura for ~20 hours at 30&deg;C in a shaking incubator set at 250 rpm. 
The next day, the OD~600~ was measured using a spectrophotometer and cells diluted to a starting OD600 between 0.15-0.2 in 7mL of SC -Ura were added to a 12-column deep well reservoir plate (4titude) containing 7 ml of SC-Ura. 
...
To extract RNA, we adapted a silica column RNA/DNA extraction protocol from Zymo Research (Irvine, California, USA). 
...
The RNA was denatured at 70&deg;C then cooled on ice.
...
Primer sets were designed to detect the mCherry coding sequence, as well as internal reference genes RPS3, PGK1 and (plasmid marker) URA3, (Supplemental Data X)
All primer sets were thoroughly validated by serial dilution and by confirming amplicon size.

RT-qPCR data was analysed using our tidyqpct R package v2.1.0-beta (https://github.com/ewallace/tidyqpcr).
...
Yeast with plasmids were grown in a 96-well deep well plate (VWR) containing 100$\mu$l  of SC-Ura medium with 2% glucose and grown for ~12 hours at 30&deg;C in a shaking incubator set at 250 rpm. 
...
For each culture, 3 technical replicates of 200$\mu$l were transferred to a 96-well black microtiter plate (Corning) and grown according to the protocol described in @Lichten2014. 
