...
Previous work by @Kosuri2013 suggests that screening a larger library of CREs would reveal a subset with even stronger quantitative interactions.
...
The contribution of our selected cis-regulatory motifs to mRNA stability, as inferred from the transcriptome-wide analysis, correlates with their effect on the abundance of reporter constructs.
...
Later, phosphorylation of Khd1 and Puf6 by bud-membrane-localised kinases leads to translational activation and the localisation of the ASH1 mRNP [@Paquin2007; @Deng2008].
...
Future work on CREs should acknowledge that gene expression cannot be completely decomposed into contributions from independently acting parts. 
The characterisation of a elements' function in a single context is not enough to make generalisable conclusions.
