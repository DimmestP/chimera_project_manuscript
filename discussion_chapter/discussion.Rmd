...
Our quantitative measurements of promoter-terminator swaps and cis-regulatory element combinations show that the modularity practically implemented across biology does not correlate with the function modulatity of regulatory parts.
...
Our chosen cis-regulatory elements, shortlisted by predicting half life, displayed contirbutions to overal gene expression when inserted/deleted from three host terminators.
...
The disparity between practical modularity and functional modularity raises issues with current methods for discovering novel cis-regulatory elements and understanding and manipulatiing regulatory process across biology.
