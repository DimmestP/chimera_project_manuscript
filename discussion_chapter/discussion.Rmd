...
Our quantitative measurements of CRE combinations show that the practical abstraction of genes into modular parts does not directly imply their functional modularity.
Building upon previous work by @Curran2013, we find that the relative contribution of terminators to RNA and protein levels depends on both promoter and coding sequence.
Furthermore, we find that the effect of short regulatory motifs in the 3'UTR depends both on their immediate sequence context in the 3'UTR, and on the sequence of the promoter, which is hundreds of nucleotides away at the other end of the coding region.
...
The disparity between practical modularity and functional modularity raises questions with current methods for discovering novel cis-regulatory elements, and more generally for understanding and enginnering gene regulation.
