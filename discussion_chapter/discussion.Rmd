...
Our results support previous studies showing the unpredictability in the expression of combinations of otherwise well-characterised regulatory elements.
In the creation of biological circuits, for example, time-consuming directed evolution assays have been implemented to overcome mis-matched in component expression levels [@Yokobayashi2002].
However, the availability of extensively characterised parts libraries now enables large scale searches for CREs with suitible expression.
Together with high-throughput, multiplexed RNAseq assays pools of combinations of suitable CREs can be quickly screened for the correct expression levels [@Kosuri2013]. 