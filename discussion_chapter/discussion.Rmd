...
Furthermore, we find that the effect of short CREs in 3'UTRs depends on the sequence context of their host construct.
...
The regulatory behavior of a motif depends on both its internal and external context. 
