...
Modular assembly is now routine: modern DNA synthesis and cloning techniques allow the construction of complex gene pathways through the combinatorial assembly of chosen parts [@Curran2013; @Guo2015; @Lee2015; @Garcia2018; @Andreou2018]. 
...
Testing of standardised libraries tends to focus on one kind of part at a time, for example testing many promoters with the same coding sequence and terminator [@Guo2015].
