...
Subsequent efforts have focussed on the the characterisation of these parts libraries assuming independent contribution to gene expression from promoter (Lee et al. 2015, Guo et al. 2015, Lubliner et al. 2013) and terminator parts (Yamanishi et al. 2013).
...
Previous papers characterising the effect of different native yeast terminators on protein production have shown provisional evidence that the promoter selection changes the relative contribution observed based on terminator selection (Curran et al. 2013, Wei et al. 2017).
When coupled with different promoters, the relative difference in protein output between terminators vary, with a maximum difference of 11-fold when coupled with a low expression promoter (Curran et al. 2013).
...
Lists of suspected cis-regulatory elements have been collated by searching for common motifs in genes grouped by similar characteristics, such as half lives, (Shalgi et al., 2005, Cheng et al., 2017) or grouped by binding to an immobilised protein (Kretz et al. 2013, Siprashvili et al. 2016).
Alternatively, direct evidence for transcript binding sites can be obtain by in vitro cross-linking assays (Zhao et al., 2010, Granneman et al, 2009).
...
Packages like the MEME-suite (Bailey et al., 2015), excel at determining short consensus sequences containing highly redundant nucleotides but cannot support interacting effects between motifs or regions.
...
k-mer searches allow for the detection of large numbers of exact motifs with model selection algorthims, such as penalised linear regression methods like GLMNET (Friedmann et al., 2010), by filtering out insignificant terms. 
Nonetheless, previous usages of k-mer searches continue to consider the effect of motifs in isolation of  overall context (Vijayabaskar et al., 2019). 
