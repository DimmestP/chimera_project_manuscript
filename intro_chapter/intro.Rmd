...
It is tempting to assume that the characterisation of a part in a single context (of other parts) is sufficient to predict its function in a different context.
...
That is, that modularly assembled genes are also composable.
