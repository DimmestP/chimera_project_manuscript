...
Meanwhile, for the discovery of novel CREs, computational methods embed practical modularity into their searches by assuming Boolean logic.
...
These studies have shown non-linear interactions between CREs suggesting the regulatory behavour of CREs is not modular. 
...
Here, we provide further evidence for the limitations of practical modularity in explaining the behaviour of regulatory regions and, for the first time, show that short CREs exhibit similar non-linear behaviour. 
