...
Assigning specific characteristics to individual elements of a gene has facilitated the assumption that parts are modular or interchangeable with other similar parts.
...
These experiments do not measure interactions between different parts and, therefore, an assumption of composability is required to predict their contributions to gene expression when present in other combinations.
...
Our results demonstrate that the incorporation of candidate decay motifs indeed results in a decrease in mRNA abundance, however their quantitative contribution depends on the host 3'UTR and the paired promoter.
