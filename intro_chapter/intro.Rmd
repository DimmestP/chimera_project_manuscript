...
Our results demonstrate that the incorporation of candidate decay motifs indeed results in a decrease in mRNA abundance, however their quantitative contribution depends on both the local 3'UTR context and the distant promoter context.
