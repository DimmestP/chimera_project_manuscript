...
However, it is unclear to what extent the quantitative effect of CREs to gene expression outcomes depend on other CREs present in the same gene: are they functionally modular?
Our study first highlights the limitations of the assumption of independent effects in budding yeast, by confirming that the quantitative effect of a terminator depends on both promoter and coding sequence.
