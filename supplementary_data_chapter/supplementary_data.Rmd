...
```{r TGTACAAUA_motif_coef}
TGTACAAUA_motif_table <- read.csv(here("./supplementary_data_chapter/data/HWNCAUUWY_shortlisted_motif_table.csv")) %>%
  rename("term" = "Motif", "total_count" = "Total Count")
knitr::kable(TGTACAAUA_motif_table)
```
