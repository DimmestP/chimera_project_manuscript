...
```{r secondary_structure, fig.cap="\\textbf{Designs of modified 3'UTRs aimed at minimsing disruption to the secondary structure.} The computed minimum fre energy (MFE) and the corresponding structure result using RNAfold. The modified 3'UTRs were designed, taking into consideration the MFE, and tailoring designs that would result in minimal change to the MFE.", out.height='110mm', out.width= '', fig.align='center'}
#knitr::include_graphics(here("supplementary_data_chapter/figures/secondary_structure.png"))
```