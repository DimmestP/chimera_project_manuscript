...
```{r rnaseq-QC-QuantSeq-vs-5PSeq, fig.cap="\\textbf{QuantSeq and 5PSeq genome wide transcript abundances are well correlated.} Correlation plots of DESeq2 normalised log2 pseudocounts for QuantSeq and 5PSeq are plotted against one another. The upper triangle contains the correlation coefficient of transcript abundance across all genes for each pair of samples. The lower triangle contains the scatter plot of transcripts abundance across all genes for each pair of samples. The diagonal contains a density of plot of transcript abundance across all genes in a sample.", fig.align='center',out.width="85%"}
