...
```{r mCherry-seq}
knitr::kable(tibble(" " = " "), caption = "\\textbf{Table showing the DNA sequences for all mCherry reporter constructs.}", format = "latex", align = "c")  %>%
...
```{r mTurq-seq}
knitr::kable(tibble(" " = " "), caption = "\\textbf{Table showing the DNA sequences for all mTurq reporter constructs.}", format = "latex", align = "c")  %>%
  kableExtra::kable_styling(latex_options = "hold_position") %>%
  kableExtra::column_spec(1, width="40em")
```
