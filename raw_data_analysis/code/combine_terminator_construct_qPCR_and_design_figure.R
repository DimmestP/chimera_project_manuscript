...
insertion_construct_displaytable <- 
  tableGrob(tibble("Construct" = c("mod_NNN", "mod_NAA", "mod_NTN",
...
grid.arrange(insertion_construct_displaytable)
insertion_construct_plot <- wrap_elements(full = (wrap_elements(full = (ggdraw() + 
  ...
  wrap_elements(full = insertion_construct_displaytable) + 
...
deletion_construct_displaytable <- 
  tableGrob(tibble("Construct" = rev(c("mod_NTNNN", "mod_ANNNN", "mod_ATNNN", "mod_ATHNH", 
...
grid.arrange(deletion_construct_displaytable)
...
deletion_construct_plot <- wrap_elements(full = (wrap_elements(full = (ggdraw() + 
                                                    ...
                                                    wrap_elements(full = deletion_construct_displaytable) + 
                                                    wrap_elements(full = (ggdraw() + 
