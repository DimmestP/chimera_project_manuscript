...
mCh_platereader_figure <- ggplot(data=norm_pro_mCh_ter_all %>% mutate(Terminator = str_remove(Terminator, "_long")) %>% dplyr::rename(fluo_per_OD_at_max_gr = "norm_fluo_per_OD_at_max_gr")) +
