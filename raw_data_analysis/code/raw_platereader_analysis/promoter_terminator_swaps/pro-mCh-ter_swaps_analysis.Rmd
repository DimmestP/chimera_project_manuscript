...
ggsave(here("./results_chapter/figures/pro_ter_platereader_mCh.png"),mCh_platereader_figure,width = 7, height = 5)
```

```{r plot_raw_all_points}
mCh_platereader_raw_figure <- ggplot(pro_mCh_ter %>% rename(fluo_per_OD_at_max_gr = "mCh_per_OD_at_max_gr")) +
  protein_raw_abundance_figure_options +
  facet_wrap(~Promoter) +
  labs(x="Fluorescence per OD at max growth rate")

ggsave(here("./results_chapter/figures/pro_ter_platereader_raw_mCh.png"),mCh_platereader_raw_figure,width = 5, height = 4)
```