...
motif_term_dictionary <- model_coefficients %>% 
  distinct(term) %>%
  mutate(new_term = c("Construct", "exp_repExpRep2", "ATATTC", "GTATACCTA", "UGUAHMNUA", "HWNCAUUWY", "Wildtype\n vs Mod0", "UGUAHMNUA\n+\nHWNCAUUWY"))
...
individual_linear_model_coefficients_points <- ggplot(model_coefficients %>% 
  ...
  facet_grid(~factor(new_term, c("Construct", "Wildtype\n vs Mod0", "ATATTC", "GTATACCTA", "UGUAHMNUA", "HWNCAUUWY", "UGUAHMNUA\n+\nHWNCAUUWY")), 
             scales = "free_x", 
             space = "free_x", 
             switch = "x") +
  geom_hline(yintercept = 0)

ggsave(here("raw_data_analysis/figures/motif_multi_context_coefficient.png"), individual_linear_model_coefficients_points, width = 12, height = 9)
