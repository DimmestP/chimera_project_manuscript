...
construct_dictionary_PIR1 <- tibble( construct = c("modA", "modB", "modC", "modD", "modE", "mod_F", "mod_G", "WT"), new_construct = c( "mod_ANHHH", "mod_NTHHH", "mod_ATNHH", "mod_ATHNH", "mod_ATNNN", "mod_ANNNN", "mod_NTNNN", "WT_ATHHH"))
...
pred_vs_abundance_RPS3_TSA1 <- ggplot(combined_pred_vs_actual_plot_data_TSA1_RPS3 %>% filter(terminator %in% c("tRPS3", "tTSA1"))) + 
  ...
  geom_text(aes(label = r_cor_label), data = r_cor_data_TSA1_RPS3, x = -1.1, y= 1, parse = TRUE, size = 4) +
