...
knitr::opts_chunk$set(warning=FALSE,message=FALSE,echo=TRUE,cache=FALSE,
                      #results="show",
                      fig.path="figures_pRPS3_pPGK1_pSRO9_tRPS3mod/")
...
plates_RPS3_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pRPS3-tRPS3/JA_20200121-pRPS3-tRPS3mod-n1-ct.txt")) %>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_RPS3_1)


plates_RPS3_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pRPS3-tRPS3/JA_20200204-pRPS3-tRPS3mod-n2-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_RPS3_2)

plates_PGK1_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pPGK1-tRPS3/JA_20200221_pPGK1-tRPS3mod-n1-ct.txt")) %>%
    mutate(exp_rep = 1, exp_rep=factor(exp_rep)) %>% 
    left_join(plateplan_PGK1_1)

plates_PGK1_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pPGK1-tRPS3/JA_20200311-pPGK1-tRPS3mod-n2-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_PGK1_2)

plates_SRO9_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pSRO9-tRPS3/JA_20200814-pSRO9-tRPS3mod-n1-ct.txt")) %>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_SRO9_1)

plates_SRO9_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pSRO9-tRPS3/JA_20200924-pSRO9-tRPS3mod_n2-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
...
platecurve_RPS3_1 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pRPS3-tRPS3/JA_20200121-pRPS3-tRPS3mod-n1.txt"),skip=2,
                      col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
    debaseline() %>%left_join(plateplan_RPS3_1)%>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep))

platecurve_RPS3_2 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pRPS3-tRPS3/JA_20200204-pRPS3-tRPS3mod-n2.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
...
platesmelt_RPS3 <- platecurve_RPS3 %>% filter(program_no != 2) %>% getdRdTall() %>% filter(temperature >= 61)  
```
...
platecurve_PGK1_1 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pPGK1-tRPS3/JA_20200221_pPGK1-tRPS3mod-n1.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
    debaseline() %>%left_join(plateplan_PGK1_1)%>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep))

platecurve_PGK1_2 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pPGK1-tRPS3/JA_20200311-pPGK1-tRPS3mod-n2.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
...
platecurve_SRO9_1 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pSRO9-tRPS3/JA_20200814-pSRO9-tRPS3mod-n1.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
    debaseline() %>%left_join(plateplan_SRO9_1)%>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep))

platecurve_SRO9_2 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pSRO9-tRPS3/JA_20200924-pSRO9-tRPS3mod_n2.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
...
write.csv(platesnorm_summarise,here("raw_data_analysis/data/norm_qpcr/pRPS3_pPGK1_pSRO9_tRPS3_deltacq_platesnorm_summarise.csv"), row.names = FALSE)
...
# Calculates the mean cq value of pSRO9-mCherry-tRPS3_mod0 Samples (4.245926)
...
# Calculates the mean cq value of pSRO9-mCherry-tRPS3_mod0 Samples (3.887037)
...
platesnorm_mod0_median_exp_rep <- bind_rows(platesnorm_mod0_pRPS3_exp_rep1, platesnorm_mod0_pRPS3_exp_rep2,
                    ...
                    mutate(ter_mod = factor(ter_mod,levels=c("tRPS3_WT", "tRPS3_modC","tRPS3_modE","tRPS3_modD","tRPS3_modA",
...
normalised_plot_exp_rep <- ggplot(data = platesnorm_mod0_median_exp_rep)+
    ...
    guides(colour=FALSE) +
    theme(axis.text.y=element_text(colour=c("grey50", "#288a2e","#a84a9a","#6f3ba1","#416db0","#CC6666","black")),
