...
platesR3_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/JA_20200121-pRPS3-tRPS3mod-n1-ct.txt")) %>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep)) %>%
    left_join(plateplanR3_1)


platesR3_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/JA_20200204-pRPS3-tRPS3mod-n2-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
    left_join(plateplanR3_2)

platesP1_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/JA_20200221_pPGK1-tRPS3mod-n1-ct.txt")) %>%
    mutate(exp_rep = 1, exp_rep=factor(exp_rep)) %>% 
    left_join(plateplanP1_1)

platesP1_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/JA_20200311-pPGK1-tRPS3mod-n2-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
    left_join(plateplanP1_2)

platesS9_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/JA_20200814-pSRO9-tRPS3mod-n1-ct.txt")) %>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep)) %>%
    left_join(plateplanS9_1)

platesS9_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/JA_20200924-pSRO9-tRPS3mod_n2rep-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
    left_join(plateplanS9_2)


plates <- bind_rows(platesR3_1,platesR3_2,platesP1_1,platesP1_2, platesS9_1, platesS9_2) 
