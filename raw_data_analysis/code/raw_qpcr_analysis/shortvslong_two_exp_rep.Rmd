...
ggsave( here("./results_chapter/figures/RPS3_SRO9_short_vs_long.png"),plot_grid(normalised_plot_RPS3, normalised_plot_SRO9, ncol=2),  width = 163, height = 80, unit = "mm")
```