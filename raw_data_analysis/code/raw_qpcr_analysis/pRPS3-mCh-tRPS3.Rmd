...
#write_csv(platesnorm_pRPS3, here("raw_data_analysis/data/norm_qpcr/pRPS3_tRPS3_n1_n2_norm_RPS3.csv"))
...
normalised_plot_pRPS3_tRPS3 <- ggplot(data = platesnorm_mod0_median %>% 
...
normalised_plot_pRPS3_tRPS3 + stat_summary(aes(RNA_abundance,ter_mod),
