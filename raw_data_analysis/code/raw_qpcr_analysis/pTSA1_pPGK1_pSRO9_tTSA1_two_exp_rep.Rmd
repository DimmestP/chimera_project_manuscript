...
plates_TSA1_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pTSA1-tTSA1/20200731-pTSA1-tTSA1mod-n1-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_TSA1_2)

plates_TSA1_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pTSA1-tTSA1/20200801-pTSA1-tTSA1mod-n2-ct.txt")) %>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_TSA1_1)

plates_PGK1_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pPGK1-tTSA1/20200801-pPGK1-tTSA1mod-n1-ct.txt")) %>%
    mutate(exp_rep = 1, exp_rep=factor(exp_rep)) %>% 
    left_join(plateplan_PGK1_1)

plates_PGK1_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pPGK1-tTSA1/20200802-pPGK1-tTSA1mod-n2-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_PGK1_2)

plates_SRO9_1 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pSRO9-tTSA1/JA_20201109_pSRO9-tTSA1mod_n1-ct.txt")) %>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep)) %>%
    left_join(plateplan_SRO9_1)

plates_SRO9_2 <- read_lightcycler_1colour_cq(here("raw_data_analysis/data/raw_qpcr/pSRO9-tTSA1/JA_20201109_pSRO9-tTSA1mod_n2-ct.txt")) %>%
    mutate(exp_rep = 2,exp_rep=factor(exp_rep)) %>%
...
platecurve_TSA1_1 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pTSA1-tTSA1/20200731-pTSA1-tTSA1mod-n1.txt"),skip=2,
                      col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
    debaseline() %>%left_join(plateplan_TSA1_1)%>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep))

platecurve_TSA1_2 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pTSA1-tTSA1/20200801-pTSA1-tTSA1mod-n2.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
...
platecurve_PGK1_1 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pPGK1-tTSA1/20200801-pPGK1-tTSA1mod-n1.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
    debaseline() %>%left_join(plateplan_PGK1_1)%>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep))

platecurve_PGK1_2 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pPGK1-tTSA1/20200802-pPGK1-tTSA1mod-n2.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
...
platecurve_SRO9_1 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pSRO9-tTSA1/JA_20201109_pSRO9-tTSA1mod_n1.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
    debaseline() %>%left_join(plateplan_SRO9_1)%>%
    mutate(exp_rep = 1,exp_rep=factor(exp_rep))

platecurve_SRO9_2 <- read_tsv(here("raw_data_analysis/data/raw_qpcr/pSRO9-tTSA1/JA_20201109_pSRO9-tTSA1mod_n2.txt"),skip=2,
                           col_names=c("well","SID","program_no","segment","cycle","time","temperature","fluor_raw")) %>%
...
write.csv(platesnorm_summarise,here("raw_data_analysis/data/norm_qpcr/pTSA1_pPGK1_pSRO9_tTSA1_deltacq_platesnorm_summarise.csv"), row.names = FALSE)
...
platesnorm_mod0_median_exp_rep <- bind_rows(platesnorm_mod0_pTSA1_exp_rep1, platesnorm_mod0_pTSA1_exp_rep2,
                    ...
                    mutate(ter_mod = factor(ter_mod,levels=c("tTSA1_WT", "tTSA1_modC","tTSA1_modE","tTSA1_modD","tTSA1_modA",
...
normalised_plot_exp_rep <- ggplot(data = platesnorm_mod0_median_exp_rep)+
    ...
    scale_x_log2nice(name="Fold change in RNA abundance relative to tTSA1-mod0 (log2 scale)",omag = seq(-5,5),scilabels=FALSE) +
      labs(y="") +
