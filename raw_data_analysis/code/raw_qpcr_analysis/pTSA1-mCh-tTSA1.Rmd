...
#write_csv(platesnorm_pTSA1, here("raw_data_analysis/data/norm_qpcr/pTSA1_tTSA1_n1_n2_norm_RPS3.csv"))
...
normalised_plot_pTSA1_tTSA1 <- ggplot(data = platesnorm_mod0_median %>% 
...
normalised_plot_pTSA1_tTSA1 + stat_summary(aes(RNA_abundance,ter_mod),
