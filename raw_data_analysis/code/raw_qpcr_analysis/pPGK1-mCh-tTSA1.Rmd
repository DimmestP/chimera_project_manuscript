...
#write_csv(platesnorm_pPGK1, here("raw_data_analysis/data/norm_qpcr/pPGK1_tTSA1_n1_n2_norm_mean.csv"))
...
normalised_plot_pPGK1_tTSA1 <- ggplot(data = platesnorm_mod0_median %>% 
...
normalised_plot_pPGK1_tTSA1 + stat_summary(aes(RNA_abundance,ter_mod),
