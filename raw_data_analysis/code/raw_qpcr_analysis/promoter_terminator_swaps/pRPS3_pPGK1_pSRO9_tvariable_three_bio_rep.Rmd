...
plates_RPS3_PGK1_1 <- read_lightcycler_1colour_cq("data/JA_2020-12-12-pro-ter_pRPS3-pPGK1-n1-ct.txt")  %>%
    left_join(plateplan_RPS3_PGK1_1)

plates_RPS3_PGK1_2 <- read_lightcycler_1colour_cq("data/JA_2020-12-13-pro-ter_pRPS3-pPGK1-n2-ct.txt")  %>%
    left_join(plateplan_RPS3_PGK1_2)

plates_RPS3_PGK1_3 <- read_lightcycler_1colour_cq("data/JA_2020-12-14-pro-ter_pRPS3-pPGK1-n3-ct.txt")  %>%
    left_join(plateplan_RPS3_PGK1_3)

plates_SRO9_1_2 <- read_lightcycler_1colour_cq("data/JA_2020-12-13-pro-ter_pSRO9-n1-n2-ct.txt")  %>%
    left_join(plateplan_SRO9_1_2)

plates_SRO9_3 <- read_lightcycler_1colour_cq("data/JA_2020-12-14-pro-ter_pSRO9-n3-ct.txt")  %>%
