...
write_csv(platesnorm_mod0_median_exp_rep, here("raw_data_analysis/data/norm_qpcr/motif_context_dependence/pRPS3_pPGK1_pSRO9_tRPS3_deltadeltacq_platesnorm_summarise.csv"))
```
...
ggsave(here("results_chapter/figures/tRPS3_design_and_qpcr.png"),
       plot_grid(ggdraw() + 
                   draw_image(here("raw_data_analysis/figures/terminator_construct_designs/RPS3_motif_insertion_construct_design.svg")),
