...
ggsave(here("results_chapter/figures/tTSA1_design_and_qpcr.png"),
       plot_grid(ggdraw() + 
                   draw_image(here("raw_data_analysis/figures/terminator_construct_designs/TSA1_motif_insertion_construct_design.svg")),
...
ggsave(here("results_chapter/figures/simplified_tTSA1_design_and_qpcr.png"), simplified_plot, width = 12, height = 5)
```
