...
pSRO9_WT_reps = c("pSRO9-mCherry-tPIR1_WT_bio_rep1", "pSRO9-mCherry-tPIR1_WT_bio_rep2", "pSRO9-mCherry-tPIR1_WT_bio_rep3", "pSRO9-mCherry-tPIR1_WT_bio_rep4", "pSRO9-mCherry-tPIR1_WT_bio_rep5", "pSRO9-mCherry-tPIR1_WT_bio_rep6")

pPGK1_WT_reps = c("pPGK1-mCherry-tPIR1_WT_bio_rep1", "pPGK1-mCherry-tPIR1_WT_bio_rep2", "pPGK1-mCherry-tPIR1_WT_bio_rep3", "pPGK1-mCherry-tPIR1_WT_bio_rep4", "pPGK1-mCherry-tPIR1_WT_bio_rep5", "pPGK1-mCherry-tPIR1_WT_bio_rep6")

pPIR1_WT_reps = c("pPIR1-mCherry-tPIR1_WT_bio_rep1", "pPIR1-mCherry-tPIR1_WT_bio_rep2", "pPIR1-mCherry-tPIR1_WT_bio_rep3", "pPIR1-mCherry-tPIR1_WT_bio_rep4", "pPIR1-mCherry-tPIR1_WT_bio_rep5", "pPIR1-mCherry-tPIR1_WT_bio_rep6")
...
platesnorm_delta_delta_cq <- platesnorm %>% filter(target_id %in% "mCh-7") %>%
  ...
  group_modify(~tidyqpcr::calculate_deltadeltacq_bytargetid(.x,
                                                            ref_sample_ids = c(pSRO9_WT_reps, pPIR1_WT_reps, pPGK1_WT_reps), 
                                                            norm_function = mean))
```

## Output delta_delta_cq

```{r output-delta-delta-cq, echo=TRUE}

# Combining the calculated delta-delta cq 
...
write_csv(platesnorm_delta_delta_cq_rename, here("raw_data_analysis/data/norm_qpcr/motif_context_dependence/pPIR1_pPGK1_pSRO9_tPIR1_deltadeltacq_platesnorm_summarise.csv"))
```
