...
platesnorm_WT_median_exp_rep <- bind_rows(platesnorm_WT_pPIR1_exp_rep1, platesnorm_WT_pPIR1_exp_rep2,
                    ...
                    mutate(ter_mod = factor(ter_mod,levels=c("tPIR1_modG", "tPIR1_modF", "tPIR1_modE", "tPIR1_modD","tPIR1_modC","tPIR1_modA","tPIR1_modB", "tPIR1_WT")))
```
...
normalised_plot_exp_rep <- ggplot(data = platesnorm_WT_median_exp_rep)+
    ...
    #scale_x_log2nice(name="Fold change in RNA abundance relative to tPIR1-WT (log2 scale)",omag = seq(-5,5),scilabels=TRUE) +
    scale_x_log2nice(name="Fold change in RNA abundance relative to tPIR1-WT (log2 scale)",omag = seq(-5,5),scilabels=FALSE) +
      labs(y="") +
    scale_shape_manual(values=c(19, 17, 15, 10, 7, 14)) +
    scale_colour_manual(values=c("#971c9c","#1e1c9c","#5d1c9c","#a84a9a","#9884ab","#416db0","#CC6666","black")) +
    guides(colour=FALSE) +
    theme(axis.text.y=element_text(colour=c("#971c9c","#1e1c9c","#5d1c9c","#a84a9a","#9884ab","#416db0","#CC6666","black")),
...
normalised_plot1_exp_rep <- ggplot(data = platesnorm_WT_median_exp_rep)+
    geom_point(aes(rel_abund_delta_deltacq,ter_mod,colour=ter_mod, shape=bio_rep)) +
    scale_x_log2nice(name="Fold change in RNA abundance relative to tPIR1-WT \n (log2 scale)",omag = seq(-5,5),scilabels=FALSE) +
    labs(y="") +
    scale_shape_manual(values=c(19, 17, 15, 10, 7, 14)) +
    scale_colour_manual(values=c("#971c9c","#1e1c9c","#5d1c9c","#a84a9a","#9884ab","#416db0","#CC6666","black")) +
    guides(colour=FALSE) +
