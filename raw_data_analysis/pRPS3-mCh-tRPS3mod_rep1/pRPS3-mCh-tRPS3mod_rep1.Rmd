---
title: "RT-qPCR of pRPS3-mCh-tRPS3mod experimental replicate 1 (n=1)"
...
# read my plates
plates <- read_tsv( "data/JA_20200121_pRPS3-tRPS3mod-n1-ct.txt",skip=1) %>%
...
All -RT controls have a high CT value and all +RT reactions have a low CT value. All BioRep and techrep for each strain (+RT) seems tight.
...
-the mRNA abundance is proportional to the numberr of incorporated motifs (modA-contains one decay motif, modD-contains two decay motifs, modE-contains three decay motifs)
...
platecurve <- read_tsv("data/JA_20200121_pRPS3-tRPS3mod-n1.txt",
                       skip=2,
...
-RT seems to have a peak in the melt curve
...
-(Check with Sam and Edward)- an error appeared after knitting - "There were 50 or more warnings (use warnings() to see the first 50)"
