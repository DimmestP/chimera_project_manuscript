...
### 2A) Exporting analysed delta-delta Cq values data
```{r export_normdata, echo=TRUE}
#exporting platesnorm_mod0_median dataframe
write.csv(platesnorm_mod0_median,"analysed_data/platesnorm_mod0_median.csv", row.names = FALSE)
```
