---
title: "RT-qPCR of pPGK1-mCh-tRPS3mod experimental replicate 2 (n=2)"
...
knitr::opts_chunk$set(warning=FALSE,message=FALSE,echo=TRUE,cache=FALSE,
                      results="show",
                      fig.path="figures/analyse-qPCR-2020-03-11_pPGK1-tRPS3mod",
                      cache.path="cache/analyse-qPCR-2020-03-11_pPGK1-tRPS3mod")
...
# read my plates
plates <- read_tsv( "data/JA_20200311-pPGK1-tRPS3mod-n2-ct.txt",skip=1) %>%
...
This looks better. The only sample with high relative CT values is POT1-ccdb
...
-Differences in mRNA abundance between bioreps for each sample seems a lot higher (mod0, modA and modC). 

mRNA abundance for linear combinations (modA, D and E)
-unlike rep1, we don't see the lower mRNA abundance only in modD with modA=modE. Here, abundances are similar between modD and modE, and modA has a higher abundance than both

Same as pRPS3-mCh-tRPS3 datasets,
-There doesn't seem to be much difference between WT and mod0

-There is a slightly higher mRNA abundance in the 3'UTR with an incorporated putative stability motif
...
platecurve <- read_tsv("data/JA_20200311-pPGK1-tRPS3mod-n2.txt",
                       skip=2,
